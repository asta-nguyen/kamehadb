export type WorkspaceTab =
  ...
  | { readonly id: string; readonly type: 'sqlite3'; readonly title: string; readonly connectionId: string }
  | { readonly id: string; readonly type: 'sqlcmd'; readonly title: string; readonly connectionId: string }
  | {
      readonly id: string;
      readonly type: 'sqlserver-vec-search';
      readonly title: string;
      readonly connectionId: string;
  ...
  | {
      readonly id: string;
      readonly type: 'sqlserver-vec-map';
      readonly title: string;
      readonly connectionId: string;
      readonly schema: string;
      readonly table: string;
