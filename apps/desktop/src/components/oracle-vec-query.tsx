...
import { useOracleVectorCapabilities, useOracleVectorSearch } from '@/hooks/use-oracle-vec';
    ...
    <div className="flex flex-col h-full">
      <div className="p-3 border-b border-border space-y-2">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Select
            value={state.metric}
            onValueChange={(value) => dispatch({ type: 'setMetric', value: value as OracleVecQueryState['metric'] })}
          >
          ...
          <Input
            ...
            max={1000}
            value={state.limit}
            onChange={(event) => dispatch({ type: 'setLimit', value: parseInt(event.target.value, 10) || 10 })}
