...
const TOOL_GROUPS: readonly ToolGroup[] = [
  ...
  {
    label: 'SQLite',
    description: 'sqlite3 CLI shell',
    tools: ['sqlite3'],
  },
  {
    label: 'SQL Server',
    description: 'sqlcmd CLI shell',
    tools: ['sqlcmd'],
  },
  {
    label: 'Oracle',
    description: 'sqlplus CLI shell, expdp/impdp backup & restore',
    tools: ['sqlplus'],
  },
  {
    label: 'ClickHouse',
    description: 'clickhouse-client CLI shell',
    tools: ['clickhouse-client'],
  },
  {
    label: 'DuckDB',
    description: 'duckdb CLI shell',
    tools: ['duckdb'],
  },
];
